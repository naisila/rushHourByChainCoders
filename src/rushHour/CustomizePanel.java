...
public class CustomizePanel extends JPanel {
	 ...
	 */
	public CustomizePanel(FileManagementSystem fmsi) throws FileNotFoundException, UnsupportedAudioFileException, IOException, LineUnavailableException {
		fms = fmsi;
		u = fms.getUserData();
		...
		cust.setIcon(new ImageIcon(new ImageIcon("src/rushHour/images/customize.png").getImage()
				.getScaledInstance(300, 60, Image.SCALE_DEFAULT)));
		cust.setBounds(220, 10, 291, 41);
		add(cust);

		ImageIcon icone = new ImageIcon(
				new ImageIcon("src/rushHour/images/back.png").getImage().getScaledInstance(120, 65, Image.SCALE_DEFAULT));
		...
		garage.setIcon(new ImageIcon(new ImageIcon("src/rushHour/images/regBlue.png").getImage().getScaledInstance(68, 44, Image.SCALE_DEFAULT)));
		add(garage);
		...
		email.setIcon(new ImageIcon(new ImageIcon("src/rushHour/images/email.png").getImage()
		...
		beware.setIcon(new ImageIcon(new ImageIcon("src/rushHour/images/exclMark.png").getImage()
